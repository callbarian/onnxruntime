...
enum FmhaQkvFormat {
  QKV_3BNSH,       // for memory efficient attention, or TRT fused causal attention, or unfused attention
  QKV_3BSNH,       // for memory efficient attention
  QKV_BSN3H,       // for TRT fused attention, qkv packed
  QKV_BSNH_BSN2H,  // for TRT fused cross attention, kv packed
};
...
struct FmhaParams {
  ...
  FmhaQkvFormat format;  // Format of Q, K, V inputs: BNSH or BSNH.
